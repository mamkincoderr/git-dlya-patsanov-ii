...
> *Хороший ПР — это не просто код. Это объяснение ЗАЧЕМ этот код. "Добавил кнопку" — плохое описание. "Добавил кнопку экспорта в CSV по запросу клиентов, работает через новый endpoint /api/export" — норм. Ревьюер скажет спасибо и замержит быстрее.*
