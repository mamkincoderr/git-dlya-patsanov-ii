...
После настройки работаешь точно так же как с GitHub — создаёшь репы, пушишь, открываешь PR. Только адрес твой:
...
> *PAT — как временный пропуск. Удобно для старта. Храни его как пароль — кто получит токен, получит доступ к твоим репам.*
...
Зайди на GitHub — там уже твои файлы и вся история коммитов.
