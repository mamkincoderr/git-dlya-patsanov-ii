...
> 🎯 **TL;DR:** Ставишь Git, говоришь кто ты, создаёшь папку, пишешь `git init` — и у тебя уже машина времени для кода. GitHub пока не нужен.
...
# Поздравляю — это уже репозиторий!
...
# Это твой первый снимок. Поздравляю!
```
...
## 🔄 Попрактикуйся — ещё пара коммитов

Сделай ещё пару изменений чтобы история ожила:
...
| Удалил папку `.git` | Репозиторий стал обычной папкой, вся история потеряна |
