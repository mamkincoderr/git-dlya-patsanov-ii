# 🚀 Урок 0: Git-жаргон для пацанов из Рунета (Нулевой уровень)
...
Крутые префиксы для сообщений коммитов:
- `feat:` — новая фича
- `fix:` — пофиксил баг
- `docs:` — документация
...
> *В Рунете часто добавляют: `feat(login): добавил авторизацию через VK`*
